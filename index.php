...
<body>
    <main>
        ...
        <div class="img-cont">
            <div class="img">
                <img src="./styles/images/school2.webp" alt="">
        ...
        <div class="mv">
            <div class="card">
                <img src="./styles/images/mission.webp" alt="PMCI">
                <div class="det">
                    <h1>MISSION</h1>
            ...
            <div class="card">
                ...
                <img src="./styles/images/vision.webp" alt="PMCI">
                <div class="det">
                    <h1>VISION</H1>
        ...
        <div class="core">
            ...
            <div class="pmci">
                <img src="./styles/images/PMCI/p.webp" alt="P" class="pmci-img" draggable="false">
                <h3>PERSEVERANCE</h3>
            </div>

            <div class="pmci">
                <img src="./styles/images/PMCI/m.webp" alt="M" class="pmci-img" draggable="false">
                <H3>MORAL-INTEGRITY</H3>
            </div>

            <div class="pmci">
                <img src="./styles/images/PMCI/c.webp" alt="C" class="pmci-img" draggable="false">
                <H3>COMPETITIVE</H3>
            </div>

            <div class="pmci">
                <img src="./styles/images/PMCI/i.webp" alt="I" class="pmci-img" draggable="false">
                <H3>INCLUSIVENESS</H3>
            </div>
