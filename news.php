...
<body>
        ...
        <div class="news-container">
            ...
            <div class="container">
                ...
                <div class="pagination">
                    ...
                    ?>
                    <input class="fa up" style="padding: 13px 10px; border-radius: 8px; margin-top: 30px; margin-bottom: 10px;"  type="text" id="searchInput"
    ...
    <script>
        function searchNews() {
            ...
            const page = document.getElementById('bot');
